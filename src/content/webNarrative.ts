...
const SYNTH_PLACEHOLDER_VISUALS = [
  {
    imageUrl: igemStatic('/images/crispr.png'),
    imageAlt: 'CRISPR — molecular scissors and DNA target',
    sceneBgUrl: igemStatic('/images/crispr_background.png'),
  },
  {
    imageUrl: igemStatic('/images/aav.png'),
    imageAlt: 'Adeno-associated virus capsid — delivery payload limit',
    sceneBgUrl: igemStatic('/images/aav_background.png'),
  },
  {
    imageUrl: igemStatic('/images/therapy.png'),
    imageAlt: 'Schematic — therapeutic readouts',
    sceneBgUrl: igemStatic('/images/therapy_background.jpg'),
  },
    ...
    cards: [
      {
        ...
        imageUrl: igemStatic('/images/crispr.png'),
        imageAlt: 'CRISPR — molecular scissors and DNA target',
        hoverBgUrl: igemStatic('/images/crispr_background.png'),
      ...
      },
      {
        ...
        imageUrl: igemStatic('/images/aav.png'),
        imageAlt: 'Adeno-associated virus capsid — delivery payload limit',
        hoverBgUrl: igemStatic('/images/aav_background.png'),
      ...
      },
      {
        ...
        hoverBgUrl: igemStatic('/images/therapy_background.jpg'),
  ...
  lenses: [
    {
      ...
      imageUrl: igemStatic('/images/chrom.svg'),
